...
class ProductManager {
  ...
  _getFallbackProducts() {
    return [
      { id: 1, name: 'Premium Leather Jacket', slug: 'premium-leather-jacket', category: 'Fashion', brand: 'LUXE Originals', price: 299.99, salePrice: 249.99, rating: 4.8, reviewCount: 124, stock: 15, badges: ['hot'], featured: true, colors: ['#1a1a1a', '#8B4513', '#4a2c2a'], sizes: ['S', 'M', 'L', 'XL'], gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', description: 'Handcrafted from premium Italian leather with a modern slim fit.', images: [], tags: ['leather', 'jacket', 'premium'], specifications: { Material: '100% Italian Leather', Fit: 'Slim Fit', Lining: 'Silk Blend', Care: 'Professional Leather Clean' } },
      { id: 2, name: 'Wireless Noise-Cancelling Headphones', slug: 'wireless-noise-cancelling-headphones', category: 'Electronics', brand: 'SoundElite', price: 349.99, salePrice: 279.99, rating: 4.9, reviewCount: 256, stock: 30, badges: ['new'], featured: true, colors: ['#1a1a1a', '#c0c0c0', '#1e3a5f'], gradient: 'linear-gradient(135deg, #0c3483 0%, #a2b6df 100%)', description: 'Experience pure sound with active noise cancellation and 40-hour battery.', images: [], tags: ['headphones', 'wireless', 'audio'], specifications: { Driver: '40mm Custom', Battery: '40 hours', Noise: 'Active NC', Bluetooth: '5.3' } },
      { id: 3, name: 'Classic Running Shoes', slug: 'classic-running-shoes', category: 'Sports', brand: 'RunPro', price: 179.99, salePrice: null, rating: 4.6, reviewCount: 89, stock: 45, badges: [], featured: true, colors: ['#ffffff', '#1a1a1a', '#ff4444'], sizes: ['7', '8', '9', '10', '11', '12'], gradient: 'linear-gradient(135deg, #89f7fe 0%, #66a6ff 100%)', description: 'Engineered for performance with responsive cushioning.', images: [], tags: ['shoes', 'running', 'sports'], specifications: { Upper: 'Breathable Mesh', Sole: 'Responsive Foam', Weight: '280g', Drop: '8mm' } },
      { id: 4, name: 'Organic Face Serum', slug: 'organic-face-serum', category: 'Beauty', brand: 'GlowNaturals', price: 89.99, salePrice: 69.99, rating: 4.7, reviewCount: 203, stock: 60, badges: ['sale'], featured: true, colors: [], gradient: 'linear-gradient(135deg, #f5576c 0%, #ff6f91 100%)', description: 'Vitamin C enriched serum for radiant, youthful skin.', images: [], tags: ['skincare', 'serum', 'organic'], specifications: { Volume: '30ml', Ingredients: 'Vitamin C, Hyaluronic Acid', 'Skin Type': 'All Skin Types', Usage: 'Twice Daily' } },
      { id: 5, name: 'Minimalist Ceramic Vase', slug: 'minimalist-ceramic-vase', category: 'Home', brand: 'ArtHome', price: 59.99, salePrice: null, rating: 4.5, reviewCount: 67, stock: 25, badges: ['new'], featured: true, colors: ['#ffffff', '#f5f5dc', '#808080'], gradient: 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%)', description: 'Hand-crafted ceramic vase with a contemporary design.', images: [], tags: ['vase', 'home', 'decor'], specifications: { Material: 'Premium Ceramic', Height: '30cm', Weight: '1.2kg', Care: 'Hand Wash' } },
      { id: 6, name: 'Designer Sunglasses', slug: 'designer-sunglasses', category: 'Fashion', brand: 'VisionLux', price: 199.99, salePrice: 159.99, rating: 4.4, reviewCount: 178, stock: 35, badges: ['sale'], featured: true, colors: ['#1a1a1a', '#8B4513', '#4169E1'], gradient: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', description: 'UV400 protection with polarized lenses in a timeless aviator frame.', images: [], tags: ['sunglasses', 'fashion', 'accessories'], specifications: { Lens: 'Polarized UV400', Frame: 'Titanium Alloy', Weight: '28g', Case: 'Included' } },
      { id: 7, name: 'Smart Fitness Watch', slug: 'smart-fitness-watch', category: 'Electronics', brand: 'TechFit', price: 249.99, salePrice: null, rating: 4.6, reviewCount: 312, stock: 50, badges: ['hot'], featured: true, colors: ['#1a1a1a', '#c0c0c0', '#003366'], gradient: 'linear-gradient(135deg, #1e3c72 0%, #2a5298 100%)', description: 'Advanced health monitoring with GPS and 7-day battery life.', images: [], tags: ['watch', 'fitness', 'smart'], specifications: { Display: '1.4" AMOLED', Battery: '7 days', Water: '5ATM', Sensors: 'HR, SpO2, GPS' } },
      { id: 8, name: 'Cashmere Blend Scarf', slug: 'cashmere-blend-scarf', category: 'Fashion', brand: 'LUXE Originals', price: 129.99, salePrice: 99.99, rating: 4.8, reviewCount: 95, stock: 20, badges: [], featured: true, colors: ['#8B0000', '#191970', '#808080', '#F5F5DC'], gradient: 'linear-gradient(135deg, #a18cd1 0%, #fbc2eb 100%)', description: 'Luxuriously soft cashmere blend scarf for effortless elegance.', images: [], tags: ['scarf', 'cashmere', 'winter'], specifications: { Material: '70% Cashmere, 30% Silk', Size: '200cm x 70cm', Weight: '180g', Care: 'Dry Clean' } },
      { id: 9, name: 'Yoga Mat Premium', slug: 'yoga-mat-premium', category: 'Sports', brand: 'ZenFit', price: 79.99, salePrice: null, rating: 4.7, reviewCount: 142, stock: 40, badges: ['new'], featured: false, colors: ['#4B0082', '#008080', '#FF6347'], gradient: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)', description: 'Eco-friendly TPE yoga mat with superior grip and cushioning.', images: [], tags: ['yoga', 'mat', 'fitness'], specifications: { Material: 'TPE Eco-Friendly', Thickness: '6mm', Size: '183cm x 61cm', Weight: '1.5kg' } },
      { id: 10, name: 'Luxury Candle Set', slug: 'luxury-candle-set', category: 'Home', brand: 'ArtHome', price: 49.99, salePrice: 39.99, rating: 4.6, reviewCount: 88, stock: 55, badges: ['sale'], featured: false, colors: [], gradient: 'linear-gradient(135deg, #a1c4fd 0%, #c2e9fb 100%)', description: 'Set of 3 hand-poured soy candles with natural essential oils.', images: [], tags: ['candle', 'home', 'gift'], specifications: { Material: 'Soy Wax', 'Burn Time': '45 hours each', Scents: 'Lavender, Vanilla, Cedar', Quantity: '3 candles' } },
      { id: 11, name: 'Anti-Aging Night Cream', slug: 'anti-aging-night-cream', category: 'Beauty', brand: 'GlowNaturals', price: 119.99, salePrice: null, rating: 4.5, reviewCount: 167, stock: 30, badges: [], featured: false, colors: [], gradient: 'linear-gradient(135deg, #fccb90 0%, #d57eeb 100%)', description: 'Retinol-enriched night cream for firmer, younger-looking skin.', images: [], tags: ['cream', 'anti-aging', 'skincare'], specifications: { Volume: '50ml', 'Key Ingredient': 'Retinol 0.5%', 'Skin Type': 'Mature Skin', Usage: 'Nightly' } },
      { id: 12, name: 'Bluetooth Portable Speaker', slug: 'bluetooth-portable-speaker', category: 'Electronics', brand: 'SoundElite', price: 149.99, salePrice: 119.99, rating: 4.5, reviewCount: 198, stock: 65, badges: ['sale'], featured: false, colors: ['#1a1a1a', '#FF4500', '#006400'], gradient: 'linear-gradient(135deg, #2b5876 0%, #4e4376 100%)', description: 'Waterproof portable speaker with 360° immersive sound.', images: [], tags: ['speaker', 'bluetooth', 'portable'], specifications: { Output: '30W', Battery: '12 hours', Waterproof: 'IPX7', Bluetooth: '5.0' } },
      { id: 13, name: 'Silk Blend Dress Shirt', slug: 'silk-blend-dress-shirt', category: 'Fashion', brand: 'LUXE Originals', price: 159.99, salePrice: null, rating: 4.4, reviewCount: 76, stock: 22, badges: [], featured: false, colors: ['#FFFFFF', '#87CEEB', '#FFC0CB', '#000000'], sizes: ['S', 'M', 'L', 'XL', 'XXL'], gradient: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', description: 'Premium silk blend dress shirt for a sophisticated look.', images: [], tags: ['shirt', 'silk', 'formal'], specifications: { Material: '60% Silk, 40% Cotton', Fit: 'Regular', Collar: 'Spread', Care: 'Dry Clean Recommended' } },
      { id: 14, name: 'Essential Oil Diffuser', slug: 'essential-oil-diffuser', category: 'Home', brand: 'ArtHome', price: 69.99, salePrice: null, rating: 4.8, reviewCount: 231, stock: 48, badges: ['hot'], featured: false, colors: ['#FFFFFF', '#D2B48C'], gradient: 'linear-gradient(135deg, #d4fc79 0%, #96e6a1 100%)', description: 'Ultrasonic aromatherapy diffuser with ambient LED lighting.', images: [], tags: ['diffuser', 'aromatherapy', 'wellness'], specifications: { Capacity: '400ml', Runtime: '10 hours', Features: '7 LED Colors', Coverage: '30-50m²' } },
      { id: 15, name: 'Performance Training Shorts', slug: 'performance-training-shorts', category: 'Sports', brand: 'RunPro', price: 49.99, salePrice: 39.99, rating: 4.3, reviewCount: 54, stock: 75, badges: ['sale'], featured: false, colors: ['#1a1a1a', '#191970', '#228B22'], sizes: ['S', 'M', 'L', 'XL'], gradient: 'linear-gradient(135deg, #d299c2 0%, #fef9d7 100%)', description: 'Moisture-wicking training shorts with zippered pockets.', images: [], tags: ['shorts', 'training', 'gym'], specifications: { Material: 'Polyester/Elastane', Features: 'Moisture-Wicking', Pockets: '2 Zippered', Length: '7 inch' } },
      { id: 16, name: 'Rose Gold Watch', slug: 'rose-gold-watch', category: 'Fashion', brand: 'VisionLux', price: 399.99, salePrice: 329.99, rating: 4.9, reviewCount: 87, stock: 10, badges: ['hot'], featured: false, colors: ['#B76E79'], gradient: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)', description: 'Elegant rose gold timepiece with sapphire crystal glass.', images: [], tags: ['watch', 'rose gold', 'luxury'], specifications: { Movement: 'Swiss Quartz', Case: '36mm Rose Gold', Crystal: 'Sapphire', Water: '50m' } },
      { id: 17, name: 'Lip Care Collection', slug: 'lip-care-collection', category: 'Beauty', brand: 'GlowNaturals', price: 34.99, salePrice: null, rating: 4.6, reviewCount: 145, stock: 80, badges: ['new'], featured: false, colors: ['#FF69B4', '#DC143C', '#CD853F'], gradient: 'linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)', description: 'Nourishing lip care trio: balm, scrub, and mask.', images: [], tags: ['lip care', 'beauty', 'set'], specifications: { Contents: 'Balm, Scrub, Mask', Weight: '30g total', Ingredients: 'Shea Butter, Vitamin E', Cruelty: 'Cruelty-Free' } },
      { id: 18, name: 'Ergonomic Office Chair', slug: 'ergonomic-office-chair', category: 'Home', brand: 'ComfortPro', price: 499.99, salePrice: 399.99, rating: 4.7, reviewCount: 112, stock: 8, badges: ['sale'], featured: false, colors: ['#1a1a1a', '#808080'], gradient: 'linear-gradient(135deg, #fbc2eb 0%, #a6c1ee 100%)', description: 'Premium ergonomic chair with lumbar support and breathable mesh.', images: [], tags: ['chair', 'office', 'ergonomic'], specifications: { Material: 'Mesh + Memory Foam', Adjustable: 'Height, Arms, Lumbar', Weight: '18kg', Warranty: '5 Years' } },
      { id: 19, name: 'Wireless Earbuds Pro', slug: 'wireless-earbuds-pro', category: 'Electronics', brand: 'SoundElite', price: 199.99, salePrice: 169.99, rating: 4.8, reviewCount: 345, stock: 70, badges: ['hot'], featured: false, colors: ['#FFFFFF', '#1a1a1a'], gradient: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)', description: 'True wireless earbuds with studio-quality audio and ANC.', images: [], tags: ['earbuds', 'wireless', 'audio'], specifications: { Driver: '11mm', ANC: 'Hybrid ANC', Battery: '8h + 24h case', Codec: 'LDAC, aptX' } },
      { id: 20, name: 'Cotton Linen Throw Blanket', slug: 'cotton-linen-throw-blanket', category: 'Home', brand: 'ArtHome', price: 89.99, salePrice: null, rating: 4.5, reviewCount: 63, stock: 35, badges: [], featured: false, colors: ['#F5F5DC', '#D2B48C', '#808080'], gradient: 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%)', description: 'Soft cotton-linen throw blanket for cozy living spaces.', images: [], tags: ['blanket', 'throw', 'home'], specifications: { Material: 'Cotton/Linen Blend', Size: '150cm x 200cm', Weight: '800g', Care: 'Machine Washable' } }
    ];
  }
